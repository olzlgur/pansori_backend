...
public class SimplePrecedent {
    ...
    public SimplePrecedent(Long id, String caseId, String title, LocalDate date, String courtName, Integer courtTypeCode, String caseType, Integer caseTypeCode, String verdictType, String verdict) {
        this.id = id;
        this.caseId = caseId;
        this.title = title;
        this.date = date;
    ...
    public static SimplePrecedent JsonToSimplePrec(JSONObject object){
        ...
        return new SimplePrecedent(id,caseId, title,date,courtName,courtTypeCode,caseType,caseTypeCode,verdictType,verdict);
    }
